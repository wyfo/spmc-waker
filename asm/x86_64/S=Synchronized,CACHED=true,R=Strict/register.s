...
.LBB3_1:
	...
	jne .LBB3_1
	test dl, 2
	je <spmc_waker::SpmcWaker<spmc_waker::synchronization::Synchronized, true>>::register_impl_cold
	mov rcx, qword ptr [rdi + 8]
	mov rax, qword ptr [rdi + 16]
	cmp rcx, qword ptr [rsi + 8]
	jne <spmc_waker::SpmcWaker<spmc_waker::synchronization::Synchronized, true>>::register_impl_cold
